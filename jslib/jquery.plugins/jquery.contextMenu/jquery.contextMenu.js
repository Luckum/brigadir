...
if(jQuery)( function() {
	$.extend($.fn, {
		...
		contextMenu: function(o, callbackBeforeShow, callback) {
			// Defaults
					...
					$(this).mouseup( function(e) {
						...
						if( evt.button == 2 ) {
							...
							$('#' + o.menu).find('LI:not(.disabled) A').click( function() {
								...
								$(".contextMenu").hide();
								// Callback
								if( callback ) callback( $(this).attr('href').substr(1), $(srcElement), {x: x - offset.left, y: y - offset.top, docX: x, docY: y}, $(this).attr('rel'));
								return false;
							});
