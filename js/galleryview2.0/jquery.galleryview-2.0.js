...
/************************************************/	
			...
			if(has_filmstrip) {
				...
				if(slide_method=='strip') {
					...
					j_filmstrip.animate({
						...
						$('img',j_frames).removeClass('active');
						$($('img',j_frames[i])[0]).addClass('active');
		...
		function buildFilmstrip() {
			...
			if(has_panels) {
				var pointerArrow = $('<img style="opacity: 1; filter: alpha(opacity=100)" />');
